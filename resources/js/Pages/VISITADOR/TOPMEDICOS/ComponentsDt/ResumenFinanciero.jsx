            ...
            <div className="bg-white/80 backdrop-blur-md rounded-xl py-2.5 px-3.5 shadow-sm border border-white/40 flex items-center justify-between gap-4">
                <div className="flex-1 min-w-0">
                    <div className="flex items-baseline justify-between gap-2 w-full">
                        ...
                        <p className="text-[10.5px] font-black text-[#7C3AED] leading-none shrink-0">
                ...
                <div className="w-9 h-9 rounded-xl bg-purple-50 text-[#7C3AED] flex items-center justify-center shadow-inner shrink-0">
