...
export default function VisitadorDetalle({
    ...
    topProductos, tendencia, visitas, metaActiva, progresoMeta, mesActual,
}) {
            ...
            <div className="w-full min-h-screen bg-[#F0F4FA] pb-12">
                ...
                <div className="px-8 pt-7 space-y-7">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4">
                        <KpiCard label="Médicos visitados"  value={fmt(medicos?.length ?? 0)}                accent="#4184F0" sub={labelMes(mesActual)} />
                        <KpiCard label="Total visitas"      value={fmt(visitasStats?.total ?? 0)}            accent="#3D3FD8" sub={labelMes(mesActual)} />
