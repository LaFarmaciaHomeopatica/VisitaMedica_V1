...
const PanelAdmin = ({ children }) => {
    ...
    const menuItems = [
        ...
        { name: 'Proveedores', icon: <FaTruck />, route: '/Gproveedores' },
        { name: 'Configuracion', icon: <FaGear />, route: '/Gtarifas' },
            ...
            <header className="bg-[#4184F0] shadow-lg sticky top-0 z-50">
                <div className="w-full px-6 flex items-center justify-between h-14">
                    ...
                    <div className="flex flex-col items-start leading-none select-none">
                        ...
                        <div className="bg-white px-3 py-1 rounded-md shadow-sm mb-0.5">
                            <h1 className="text-[#00A1D9] font-sans font-bold text-sm md:text-base tracking-tight uppercase">
                                La Farmacia <span className="font-light">Homeopática</span>
                            </h1>
                        </div>

                        {/* Eslogan (Debajo del recuadro) */}
                        <span className="text-white text-[8px] md:text-[9px] font-medium tracking-wider pl-1 italic opacity-90">
                    ...
                    <div className="flex items-center gap-3">
                        <Link
                            ...
                            method="post"
                            as="button"
                            className="group flex items-center gap-2 bg-white/10 hover:bg-red-500 transition-all px-3 py-1.5 rounded-md border border-white/20 hover:border-red-500"
                        >
