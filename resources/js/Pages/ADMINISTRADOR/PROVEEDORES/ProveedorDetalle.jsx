...
import {
    FaArrowLeft, FaFileInvoiceDollar, FaReceipt,
...
export default function ProveedorDetalle({
    ...
    // Todo filtro/paginación se resuelve en el servidor (hay proveedores con
    ...
    const irA = (params) => {
        router.get(route('Gproveedores.detalle', documento), {
            estado: filtroEstado,
            pagina,
            porPagina,
            ...params,
            ...
            <div className="w-full min-h-screen bg-white pb-12">
                ...
                <div className="w-full bg-white px-6 py-3">
                    <Link href={route('Gproveedores.index')}
                        ...
                        <FaArrowLeft className="text-[8px]" /> Volver a Proveedores
                    </Link>
                    <div className="flex items-start justify-between gap-4 flex-wrap">
                        <div className="min-w-0">
                            <div className="flex items-baseline gap-2 flex-wrap">
                                ...
                                <span className="text-[9px] font-black uppercase tracking-widest text-slate-300">Cuenta del proveedor</span>
                            </div>
                ...
                <div className="px-8 pt-7 space-y-7">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <KpiCard label="Pendiente de pago" value={fmtM(resumen.pendiente)} accent="#4184F0" />
                        ...
                        {totalFacturas === 0 ? (
                            <div className="text-center py-16 text-slate-300">
                                ...
                                <p className="text-[11px] font-bold uppercase">
                                    {filtroEstado !== 'todas' ? 'Sin facturas con este estado.' : 'Sin facturas para este proveedor.'}
                                </p>
                            </div>
                        ) : (
                            <>
                            <table className={`w-full text-left border-collapse transition-opacity ${cargando ? 'opacity-40' : ''}`}>
                                <thead>
                                    <tr className="bg-blue-600">
                                        ...
                                        <th className="px-5 py-3 text-white text-[9px] font-black uppercase text-center">Pago</th>
                                    </tr>
                                </thead>
