...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("UPDATE visitadores SET nombre = SUBSTRING_INDEX(nombre_completo, ' ', 1), apellido = TRIM(SUBSTR(nombre_completo, INSTR(nombre_completo, ' '))) WHERE nombre_completo IS NOT NULL");
    ...
    public function down(): void
    {
        ...
        DB::statement("UPDATE visitadores SET nombre_completo = CONCAT(COALESCE(nombre,''), ' ', COALESCE(apellido,''))");
